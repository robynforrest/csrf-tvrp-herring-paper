...
source("R/3a_fig4_5_for_paper.R") # M B0 S-R relationships
source("R/3a_fig6_11_for_paper.R") # Time series M, B0 and Biomass
source("R/3a_fig12_for_paper.R") # Harvest control rules
