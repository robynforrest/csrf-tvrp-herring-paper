# Demo script for calculating t-v B0 from Pac herring outputs
library(here)
library(openMSE)
source(here("tmp_calc_tv_B0.R")) #contains functions calc_tv_B0, getM and getFec

# Read in WCVI Pac herring OM and histMSE
histmse <- readRDS(here("hist_hMSEwcvi.rda")) # need this because om doesn't have B0
om <- readRDS(here("OMScenario1wcvi.rda"))
nyears <- om@nyears
